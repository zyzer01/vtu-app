    ...
    >
      ...
      <div className="flex">
        ...
        <div className="mt-2 flex items-center gap-2">
          <button onClick={handleDeleteFile} className="text-destructive p-1">
            <Trash size={18} />
          </button>
        </div>
      </div>
      ...
      <div className="mb-5">
        <Label htmlFor="commaInput">Manual Input</Label>
        <Textarea
          id="commaInput"
      ...
      <div className="mb-5">
        <h3 className="font-bold">Extracted Phone Numbers:</h3>
